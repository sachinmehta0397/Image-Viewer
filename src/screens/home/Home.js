...
//material-ui styles to homepage
const styles = (theme) => ({
  card: {
    maxWidth: 1100,
...
//adding componentDidMount function to the home page
  componentDidMount() {
    let that = this;
        ...
        return Promise.all(
          mediaArray.map((x) => {
            return new Promise((resolve) => {
              let url = `https://graph.instagram.com/${
                x.id
          ...
          mediaInfo.forEach((media) => {
            ...
            media["likes_count"] = 23;

            let regex = /#(\w+)/g;
            media["hashtags"] = media.caption.match(regex);
            media["hashtags"] = media["hashtags"]
              ? media["hashtags"].join(" ")
              : "";
...
//adding comment change handler
  commentChangeHandler = (e) => {
    this.setState({
      currentComment: e.target.value,
    });
  };
//on logput click handler
  logout = () => {
...
//creating homeItem class to show the Images
class HomeItem extends Component {
  ...
  render() {
    ...
    let ss =
      createdTime.getSeconds() >= 10
        ? createdTime.getSeconds()
        : "0" + createdTime.getSeconds();
        ...
        <Card className={classes.card} variant="outlined">
          ...
          <CardContent>
            ...
            <div className={classes.hr}>
              <Typography component="p">{item.caption}</Typography>
          ...
          <CardActions>
            ...
            <Typography component="p">{item.likes_count} Likes</Typography>
          </CardActions>
